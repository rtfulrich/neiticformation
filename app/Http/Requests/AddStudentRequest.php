...
class AddStudentRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        if (request('email')) $validation['email'] = 'email|unique:teachers|unique:students';
        if (request('phone')) $validation['phone'] = 'regex:/^0( )?3( )?[234]( )?([0-9]( )?){7}$/|unique:students|unique:teachers';
        ...
        if (request('school_fee_paid')) $validation['school_fee_paid'] = 'integer|min:0';
