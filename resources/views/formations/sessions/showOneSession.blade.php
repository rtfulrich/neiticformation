    ...
    <div class="col-12 col-md-5">
        <div id="card1">
                ...
                <div class="card-body p-0">
                    <table class="table table-hover">
                        <tbody>
                            ...
                            @if ($fsession->student()->count() > 0)
                            <tr class="font-weight-bold">
                                <td>Badge</td>
                                <td><a href="{{ route('formation.session.badge-pdf', $fsession->id) }}" class="btn-sm btn-success text-center" target="_blank">Générer</a></td>
                            </tr>
                            @endif
                        </tbody>
                    </table>
            ...
            <div class="d-flex justify-content-center">
                <button id="delete-fsession-button" title="Supprimer cette vague de formation" class="btn btn-danger"><i class="fas fa-trash"></i></button>
            </div>
            @endif
        </div>
        ...
        <form id="form-section" action="{{ route('formation.session.update', $fsession->id) }}" method="post">
            ...
            <div class="mt-3 row">
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="date" name="date_debut" id="date_debut" class="form-control font-weight-bold" value="{{ $fsession->date_debut }}">
                    </div>
                </div>
                <div class="col-6">
                    <div class="form-group">
                        <label for="date_end">Date Fin</label>
                        <input type="date" name="date_end" id="date_debut" value="{{ $fsession->date_end ?? '' }}" class="form-control font-weight-bold">
                    </div>
                </div>
            </div>
            <div class="form-group input-group">
                <input type="number" step="1000" name="fee" class="form-control font-weight-bold" placeholder="Frais (en Ariary)" value="{{ $fsession->fee }}">
                <button class="btn btn-info disabled">ARIARY</button>
            </div>
            <div id="teacher-section">
                <div id="teacher-new-section" class="form-group">
                    <div class="form-group input-group">
                        <input type="text" name="teacher" class="form-control font-weight-bold" placeholder="Nom Complet">
                        <button id="cancel-new-teacher"  class="btn btn-danger"><i class="fa fa-window-close"></i></button>
                    </div>
                    <div class="form-group">
                        <input type="email" name="email" placeholder="Email" class="form-control font-weight-bold">
                    </div>
                    <div class="form-group">
            ...
            <div class="form-goup mb-3">
                <textarea name="description" rows="5" class="form-control font-weight-bold" placeholder="Description">{{ $fsession->description }}</textarea>
            </div>
            <div class="form-group input-group">
                <button  class="btn btn-danger cancel-edit"><i class="fa fa-window-close"></i></button>
                <button type="submit" class="btn btn-success form-control">UPDATE</button>
    ...
    <div class="col-12 col-md-7">
        <div id="card2" class="card">
            <header class="card-header bg-warning d-flex"  style="border-bottom: 2px solid #CCC">
                ...
                <div class="ml-auto d-flex align-items-center"><button class="btn btn-primary" title="Ajouter un nouvel étudiant pour cette vague"><i class="fas fa-plus"></i></button></div>
            </header>
            <div class="card-body p-0">
                ...
                <div class="one-student font-weight-bold d-flex align-items-center" style="border-bottom: 2px solid #CCC; border-left: 0.3px solid #CCC">
                        ...
                        <div id="school_fee_form-{{$student->id}}" class="school_fee_form form-group mx-lg-5 mx-3 mb-0">
                            <form action="{{ route('student.pay', $student->id) }}" method="post">
                                ...
                                <div class="input-group input-group-sm">
                                    <input type="number" min="0" step="1000" placeholder="Taper la Somme ici" name="school_fee_paid" class="form-control font-weight-bold" autofocus>
                    ...
                    <div style="flex: 1" class="d-flex justify-content-center">
                        ...
                        <div class="eye-icon" style="vertical-align: top; grid-row: 1 / 2">
                            <a href="{{ route('student.showOne', $student->id) }}" class="btn btn-success mx-1"><i class="fas fa-eye"></i></a>
                        </div>
                    </div>      
                </div>
                @endforeach
        ...
        <form id="form-section-student" action="{{ route('student.add', $id) }}" method="post" enctype="multipart/form-data" class="card">
            @csrf
            <div class="d-flex card-header bg-warning">
                <h1 class="text-capitalize text-center h2 font-weight-bold ">Formulaire d'Ajout d'un étudiant</h1>
                <div class="ml-auto">
            ...
            <div class="card-body bg-dark">
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <input type="text" name="fname" placeholder="Prénoms (obligatoire)" class="form-control font-weight-bold @if ($errors->has('fname')) border border-danger @endif" @if ($errors->any()) value="{{ old('fname') }}" @endif autofocus>
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <input type="text" name="lname"  @if ($errors->any()) value="{{ old('lname') }}" @endif placeholder="Nom (obligatoire)" class="form-control font-weight-bold @if ($errors->has('lname')) border border-danger @endif">
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <input type="email" name="email"  @if ($errors->any()) value="{{ old('email') }}" @endif placeholder="Email (facultatif)" class="form-control font-weight-bold @if ($errors->has('email')) border border-danger @endif">
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group input-group">
                            <button type="button"><i class="fas fa-phone"></i></button>
                            <input type="text" name="phone"  @if ($errors->any()) value="{{ old('phone') }}" @endif placeholder="03x xx xxx xx (facultatif)" class="form-control font-weight-bold @if ($errors->has('phone')) border border-danger @endif">
                        </div>
                    </div>
                    
                    <div class="col-6">
                        <div class="form-group">
                            <input type="date" name="birth_date"  @if ($errors->any()) value="{{ old('birth_date') }}" @endif id="birth_date" class="form-control font-weight-bold @if ($errors->has('birth_date')) border border-danger @endif">
                        </div>
                    </div>
                    <div class="col-6">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <input type="text" name="address"  @if ($errors->any()) value="{{ old('address') }}" @endif placeholder="Adresse (facultatif)" class="form-control font-weight-bold @if ($errors->has('address')) border border-danger @endif">
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <input type="text" name="cin"  @if ($errors->any()) value="{{ old('cin') }}" @endif placeholder="CIN (ex: 137.920.392.902) (facultatif)" class="form-control font-weight-bold @if ($errors->has('cin')) border border-danger @endif">
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <input type="text" name="actual_job"  @if ($errors->any()) value="{{ old('actual_job') }}" @endif placeholder="Travail Actuel (facultatif)" class="form-control font-weight-bold @if ($errors->has('actual_job')) border border-danger @endif">
                        </div>
                    </div>
                    <div class="col-12 col-md-3">
                        <div class="form-group">
                            <label for="photo">Photo <br/><small class="text-info">(facultatif)</small></label>
                            <input type="file" name="photo" @if ($errors->any()) value="{{ old('photo') }}" @endif class="form-control font-weight-bold @if ($errors->any()) border border-danger @endif">
                        </div>
                    </div>
                    <div class="col-12 col-md-4">
                        <div class="form-group">
                            <label for="machine_number">Numéro machine <small class="text-info">(facultatif)</small></label>
                            <input type="number" @if ($errors->any()) value="{{ old('machine_number') }}" @endif placeholder="Ne remplissez pas si l'édutiant utilise la sienne (facultatif)" min="0" class="form-control font-weight-bold @if ($errors->has('machine_number')) border border-danger @endif">
                        </div>
                    </div>
                    <div class="col-12 col-md-5">
                        <div class="form-group">
                            <label for="school_fee_paid">Somme à Payer en AR <small class="text-info">(facultatif)</small></label>
                            <input type="number" @if ($errors->any()) value="{{ old('school_fee_paid') }}" @endif min="0" step="1000" name="school_fee_paid" placeholder="Somme en AR" id="school_fee_paid" class="form-control font-weight-bold @if ($errors->has('school_fee_paid')) border border-danger @endif">
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <input type="number" name="children_number"  @if ($errors->any()) value="{{ old('children_number') }}" @endif min="0" placeholder="Nombre d'enfants (facultatif)" class="form-control font-weight-bold @if ($errors->has('childer_number')) border border-danger @endif">
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <input type="text" name="study_level" @if ($errors->any()) value="{{ old('study_level') }}" @endif placeholder="Niveau d'Etude (facultatif)" class="form-control font-weight-bold @if ($errors->has('study_level')) border border-danger @endif">
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group input-group">
...
@section('js')
    ...
    const plusButton = $('.fas.fa-plus').parent();
